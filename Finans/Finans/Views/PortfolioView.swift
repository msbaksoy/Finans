        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: AppSpacing.xxl) {
                    ...
                    // Varlık ekle butonu — merkezi tasarım sistemi kullanılarak daha erişilebilir CTA
                    Button {
                        showAddAsset = true
                    } label: {
                    ...
                    .accessibilityHint("Yeni varlık ekleme ekranını açar")
                    .padding(.horizontal, AppSpacing.xxl)
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            if chartData.isEmpty {
                ...
                // Legend: 2 sütun, küçük puntolar — solda 2, sağda 2
                    ...
                    ForEach(chartData) { item in
                        HStack(spacing: 6) {
                            ...
                            Text(item.type)
                                ...
                                .lineLimit(1)
                            Spacer()
                            Text(formatPortfolioAmount(item.value))
                                .font(.caption2)
                                .monospacedDigit()
                                .foregroundColor(appTheme.textSecondary)
                        }
...
/// Portföy tutarları — kuruş yok (virgülden sonra sıfır)
func formatPortfolioAmount(_ amount: Double) -> String {
    let formatter = NumberFormatter()
